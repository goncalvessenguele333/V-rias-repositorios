...
<html lang="pt-br">
 ...
 <form class="form-horizontal" action="enviar_process.php" method="POST"  enctype="multipart/form-data">
   <fieldset>
 ...
 <div class="col-md-4">
   <input id="name" name="name" placeholder="Informe seu nome" class="form-control input-md" required="" type="text">
 </div>
 </div>
